...
parser.add_argument("--dataset_path", type=str, default=None, help="Path to your custom dataset folder (e.g., ./datasets/NTNU_dataset)")
...
if __name__ == '__main__':
    ...
    ds = Dataset(args.dataset, args.dataset_path)
